            ...
            <div class="card">
                ...
                <form method="post" action="{{ route('home.batik.update', $batik->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img id="showImage" class="img-fluid img-thumbnail" src="{{ asset($batik->batik_picture) }}" alt="Image Show">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="batik_description" class="form-control" cols="30" rows="10">{{ $batik->batik_description }}</textarea>
